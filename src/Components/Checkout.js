...
const Checkout = () => {
  ...
  <div className="border-b border-gray-900/10 pb-12">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Exixiting Addresses </h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Choose from exixting address 
          </p>
        ...
        <li key={address.email} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
          ...
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
            Phone: <p className="text-sm leading-6 text-gray-900">{address.phone }</p>
