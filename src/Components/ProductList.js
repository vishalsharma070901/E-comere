...
const filters = [
  {
    ...
    name: "Category",
    options: [
      { value: "All-Products", label: "All-Products", checked: true },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "DerBaking Food Itemsmive",
...
const ProductList = () => {
  ...
  const handleFilter = (e,section,option) => {
    ...
    const updateItem=Product.filter((currItem)=>{
      if(e.target.checked){
  
        return currItem.category === option.value 
      }
  ...
  const handleBrand = (e,section,option) => {
    // console.log(option.value)
    // console.log(section.id)
    const updateItem=Product.filter((currItem)=>{
       return currItem.category === option.value 
